...
class TestConstructor:
    ...
    def test_custom_api_base(self):
        a = _make_adapter(api_base="https://api.algovoi.co.uk")
        assert a._api_base == "https://api.algovoi.co.uk"
...
class TestAgentCard:
    def test_name(self):
        ...
        card = a.agent_card("https://api.algovoi.co.uk")
        assert card["name"] == "TestBot"

    def test_url(self):
        a    = _make_adapter()
        card = a.agent_card("https://api.algovoi.co.uk")
        assert card["url"] == "https://api.algovoi.co.uk"
    ...
    def test_capabilities_streaming_flag(self):
        a    = _make_adapter()
        card = a.agent_card("https://api.algovoi.co.uk", supports_streaming=True)
        assert card["capabilities"]["streaming"] is True

    def test_skills_included_when_provided(self):
        a    = _make_adapter()
        skill = {"id": "kb", "name": "Knowledge Base", "description": "Premium KB"}
        card  = a.agent_card("https://api.algovoi.co.uk", skills=[skill])
...
class TestExtendedAgentCard:
    def test_has_authentication_key(self):
        a    = _make_adapter(protocol="mpp")
        card = a.extended_agent_card("https://api.algovoi.co.uk")
...
class TestFlaskAgentCard:
    def _flask_app(self, adapter: AlgoVoiA2A):
        ...
        def agent_card():
            return adapter.flask_agent_card("https://api.algovoi.co.uk")
...
class TestFlaskExtendedAgentCard:
    def _flask_app(self, adapter: AlgoVoiA2A):
        ...
        def extended_card():
            return adapter.flask_extended_agent_card("https://api.algovoi.co.uk")
