 ...
 * Author:               AlgoVoi
 * Author URI:           https://api.algovoi.co.uk
 * License:              BUSL-1.1
...
add_filter('edd_settings_gateways', function ($settings) {
    $settings['algovoi'] = [
        ...
        [
            ...
            'desc' => __('Default: https://api.algovoi.co.uk', 'algovoi-edd'),
            'type' => 'text',
            'std'  => 'https://api.algovoi.co.uk',
        ],
        [
            'id'   => 'algovoi_api_key',
...
add_action('edd_gateway_algovoi', function ($purchase_data) {
    $api_base = rtrim(edd_get_option('algovoi_api_base', 'https://api.algovoi.co.uk'), '/');
