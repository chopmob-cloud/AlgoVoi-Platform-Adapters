...
Live-tested on **Shopware 6.7.8.2 CE** against `api.algovoi.co.uk` — 2026-04-14.
...
| Field | Value |
|-------|-------|
| API Base URL | `https://api.algovoi.co.uk` (or your AlgoVoi instance) |
...
VALUES
  (UNHEX(REPLACE(UUID(),'-','')), 'AlgovoiPayment.config.apiBaseUrl',    '{"_value":"https://api.algovoi.co.uk"}', NOW()),
...
Tested end-to-end on **2026-04-14** — Shopware 6.7.8.2 CE — `your-domain.example`
