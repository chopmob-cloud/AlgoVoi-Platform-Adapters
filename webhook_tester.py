...
Environment (or edit DEFAULTS below):
    ALGOVOI_BASE_URL    e.g. https://api.algovoi.co.uk
...
BASE_URL   = os.environ.get("ALGOVOI_BASE_URL",    "https://api.algovoi.co.uk")
...
Confirmed end-to-end on **{today}** against `api.algovoi.co.uk`:
