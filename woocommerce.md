...
```json
{
  "webhook_url": "https://api.algovoi.co.uk/webhooks/woocommerce/{tenant_id}",
  "webhook_secret": "...",
  "preferred_network": "algorand_mainnet"
}
```
...
2. Copy the plugin file:
   ```bash
   scp -i ~/.ssh/your-deploy-key woocommerce/algovoi-gateway.php \
...
| API Base URL | Base URL of the AlgoVoi API (e.g. `https://api.algovoi.co.uk`) |
...
Confirmed end-to-end on **2026-04-14** against `api.algovoi.co.uk`, real WooCommerce store running WooCommerce 10.6.2 / WordPress 6.9.4:
