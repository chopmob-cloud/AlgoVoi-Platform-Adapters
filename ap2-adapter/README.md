...
Drop-in server middleware for accepting AP2 v0.1 payment mandates from AI agents. Implements the [AlgoVoi crypto-algo extension](https://api.algovoi.co.uk/ap2/extensions/crypto-algo/v1) to the AP2 v0.1 spec, adding Algorand and VOI on-chain payments to the CartMandate / PaymentMandate flow.

**v2.0.0 — 81/81 tests passing. Real ed25519 smoke-tested 2026-04-13.**

Extension URI:  `https://api.algovoi.co.uk/ap2/extensions/crypto-algo/v1`
Schema:         `https://api.algovoi.co.uk/ap2/extensions/crypto-algo/v1/schema.json`
Extensions API: `https://api.algovoi.co.uk/ap2/extensions`
...
HTTP 402 + X-AP2-Cart-Mandate header
  CartMandate.contents.payment_request.payment_methods:
    [ { supported_methods: "https://api.algovoi.co.uk/ap2/extensions/crypto-algo/v1",
...
```json
{
  ...
  "payment_response": {
    "method_name": "https://api.algovoi.co.uk/ap2/extensions/crypto-algo/v1",
    "details": {
