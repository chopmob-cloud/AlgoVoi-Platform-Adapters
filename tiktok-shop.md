...
| Test | Network | Result |
|------|---------|--------|
| `ORDER_STATUS_CHANGE` webhook -> checkout link | Webhook → checkout link | Webhook → checkout link | Webhook → checkout link | Webhook → checkout link | `algorand_mainnet` (USDC (ASA 31566704)) | Pass |
