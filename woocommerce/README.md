# WooCommerce — AlgoVoi Payment Adapter

Accepts USDC on Algorand and aUSDC on VOI as payment in your WooCommerce store via a hosted checkout redirect payment gateway.

Full integration guide: [woocommerce.md](../woocommerce.md)
...
| File | Description |
|------|-------------|
| `algovoi-gateway.php` | WooCommerce payment gateway plugin |
