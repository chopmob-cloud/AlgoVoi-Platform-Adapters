...
add_action('plugins_loaded', function () {
    ...
    class WC_AlgoVoi_Gateway extends WC_Payment_Gateway {
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'api_base'    => array('title' => 'API Base URL', 'type' => 'text',     'default' => 'https://api.algovoi.co.uk'),
        ...
        public function process_payment($order_id) {
            $order    = wc_get_order($order_id);
            $api_base = $this->get_option('api_base', 'https://api.algovoi.co.uk');
    ...
    class WC_AlgoVoi_Extension_Gateway extends WC_Payment_Gateway {
        ...
        public function render_extension_payment_ui($order_id) {
            ...
            $api_base = $order->get_meta('_algovoi_api_base') ?: 'https://api.algovoi.co.uk';
