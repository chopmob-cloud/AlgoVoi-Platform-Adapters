...
- An AlgoVoi tenant account ([sign up free](https://api.algovoi.co.uk/signup))
...
Sign up at `api.algovoi.co.uk/signup` with just your wallet address (no email required).
