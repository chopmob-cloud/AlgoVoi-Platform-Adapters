"""
AlgoVoi OpenAI Adapter — Deployment Example
============================================
A complete, runnable payment-gated AI API server.
...
Requirements:
    pip install openai flask fastapi uvicorn
...
def create_fastapi_app():
    ...
    app = FastAPI(title="AlgoVoi OpenAI Gateway")
