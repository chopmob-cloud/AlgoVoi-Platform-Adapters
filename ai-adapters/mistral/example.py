"""
AlgoVoi Mistral Adapter — Deployment Example
============================================
A complete, runnable payment-gated Mistral server.
...
Requirements:
    pip install mistralai flask fastapi uvicorn

Mistral credentials:
    Set MISTRAL_KEY environment variable
    OR pass it directly in the AlgoVoiMistral constructor below.
...
def create_flask_app():
    ...
    def chat():
        """
        Payment-gated Mistral chat endpoint.
...
def create_fastapi_app():
    ...
    app = FastAPI(title="AlgoVoi Mistral Gateway")
...
#
# Response:
#   {"content": "Bonjour! I am Mistral. How can I help you today?"}
#
#
# 4. Use a different Mistral model
# ---------------------------------
...
#   content = gate.complete(messages, model="codestral-latest")
