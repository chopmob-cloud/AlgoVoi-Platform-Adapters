"""
AlgoVoi xAI (Grok) Adapter — Deployment Example
================================================
A complete, runnable payment-gated xAI Grok server.
...
Requirements:
    pip install xai-sdk flask fastapi uvicorn

xAI credentials:
    Set XAI_KEY environment variable
    OR pass it directly in the AlgoVoiXai constructor below.
...
gate = AlgoVoiXai(
    xai_key           = os.environ.get("XAI_KEY",            "xai-..."),
    ...
    model             = os.environ.get("MODEL",              "grok-4"),
)
...
def create_flask_app():
    ...
    def chat():
        """
        Payment-gated xAI chat endpoint.
...
def create_fastapi_app():
    ...
    app = FastAPI(title="AlgoVoi xAI Gateway")
...
#
# Response:
#   {"content": "Hello! I am Grok, xAI's conversational model. How can I help?"}
#
#
# 4. Use a different Grok model
# ------------------------------
# Set MODEL env var before starting:
#   export MODEL="grok-3-mini"
#   python example.py flask
#
# Or override at call time in the route handler:
#   content = gate.complete(messages, model="grok-2-1212")
