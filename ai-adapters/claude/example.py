"""
AlgoVoi Claude Adapter — Deployment Example
============================================
A complete, runnable payment-gated Claude API server.
...
Requirements:
    pip install anthropic flask fastapi uvicorn
...
def create_flask_app():
    ...
    def chat():
        """
        Payment-gated Claude chat endpoint.
...
def create_fastapi_app():
    ...
    app = FastAPI(title="AlgoVoi Claude Gateway")
