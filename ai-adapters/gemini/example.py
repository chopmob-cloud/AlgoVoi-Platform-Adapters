"""
AlgoVoi Gemini Adapter — Deployment Example
============================================
A complete, runnable payment-gated Gemini API server.
...
Requirements:
    pip install google-genai flask fastapi uvicorn
...
gate = AlgoVoiGemini(
    gemini_key        = os.environ.get("GEMINI_KEY",      "AIza..."),
...
def create_flask_app():
    ...
    def chat():
        """
        Payment-gated Gemini chat endpoint.
...
def create_fastapi_app():
    ...
    app = FastAPI(title="AlgoVoi Gemini Gateway")
...
#
# Note: to honour per-request model overrides, pass model= to gate.complete():
#   content = gate.complete(messages, model=body.get("model"))
