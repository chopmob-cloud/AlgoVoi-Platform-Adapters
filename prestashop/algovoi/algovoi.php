...
class Algovoi extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->bootstrap   = true;
        parent::__construct();
        $this->displayName = $this->l("AlgoVoi Hosted Checkout");
        $this->description = $this->l("Accept USDC on Algorand and aUSDC on VOI via AlgoVoi.");
    }
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $option->setCallToActionText($this->l("Pay with AlgoVoi (USDC / aUSDC)"))
               ->setAction($this->context->link->getModuleLink("algovoi", "payment", [], true))
               ->setAdditionalInformation($this->l("Secure stablecoin payment. Redirects to hosted checkout."));
        return [$option];
    }
