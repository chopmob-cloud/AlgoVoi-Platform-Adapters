...
class ApiHelper
{
    ...
    public const ALGOD = [
        ...
        'voi-mainnet' => [
            'url'      => 'https://mainnet-api.voi.network',
            'asset_id' => 302190,
            'dec'      => 6,
            'ticker'   => 'aUSDC',
        ],
    ...
    public function createPaymentLink(float $amount, string $currency, string $label, string $redirectUrl): array
    {
        $payload = json_encode([
            'amount'             => round($amount, 2),
            'currency'           => $currency,
            'label'              => $label,
            'preferred_network'  => $this->getNetwork(),
