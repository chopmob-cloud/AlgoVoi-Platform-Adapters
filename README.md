...
| **AP2** | [ap2-adapter/ap2-adapter.md](./ap2-adapter/ap2-adapter.md) / [ap2-adapter/](./ap2-adapter/) | AP2 v0.1 CartMandate/PaymentMandate server middleware with AlgoVoi crypto-algo extension (`https://api1.ilovechicken.co.uk/ap2/extensions/crypto-algo/v1`). ed25519 mandate signing + on-chain AVM tx verification. | **Production ready** — CartMandate structure, real ed25519 smoke-tested 13 Apr 2026 (valid/tampered/wrong-key, both PyNaCl + cryptography paths). v2.0.0, 81/81 tests. |
