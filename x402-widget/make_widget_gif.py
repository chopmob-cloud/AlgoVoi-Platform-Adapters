...
def _title_bar(d, right_label="x402 Embeddable Widget"):
    ...
    d.text((LPAD, H-20), "your-domain.example",
...
CODE = [
    ...
    (8,  [("  <",SYN_TAG),("script ",SYN_TAG),
          ...
          ("https://your-domain.example/widget.js",SYN_VAL),('"',SYN_PUNCT),
...
def scene_editor():
    ...
    frames += _ann_frames(
        ...
        [
            "One <script> tag loads the widget from your-domain.example",
...
def scene_ready():
    frames = []
    checkout = "api.algovoi.co.uk/checkout/abc…xyz"
...
def scene_cta():
    ...
    for i in range(50):
        ...
        if i >= 36:
            ...
            d.text((RX, 380), "your-domain.example",
